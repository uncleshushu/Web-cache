...
class HTTPRequest(HTTPMessage):
    def __init__(self, sockfile=None):
        ...
        if sockfile:
            self.method, self.path, self.http_version, self.version_number = self._parse_requestline()
...
class HTTPResponse(HTTPMessage):
    def __init__(self, sockfile=None):
        ...
        if sockfile:
            self.http_version, self.version_number, self.status_code, self.reason = self._parse_responseline()
